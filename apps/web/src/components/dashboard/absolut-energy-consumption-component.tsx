...
import AbsolutEnergyConsumptionCard from "./absolut-energy-consumption-card";
...
export default function AbsolutEnergyConsumptionComponent({ startDate, endDate, sensorId, energyData }: Props) {
    ...
    const logError = (error: Error) => {
        track(`AbsolutEnergyConsumptionCard.${error.name}("${error.message}")`);
    };
