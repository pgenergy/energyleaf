        ...
        <Card style={{ position: "relative" }}>
            <CardHeader>
                ...
                <div style={{ position: "absolute", top: "10px", right: "10px" }}>
                    <InfoDialog description="Die Berechnung erfolgt basierend auf dem Stromverbrauch der aktuellen und letzten Woche in Euro und Prozent, wobei die Kosten für den Basispreis und den Arbeitspreis pro kWh berücksichtigt werden." />
                </div>
            </CardHeader>
            <CardContent>
                {predictedCost ? (
