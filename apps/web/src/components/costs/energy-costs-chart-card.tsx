    ...
    return (
        <Card className="w-full">
            <CardHeader>
                ...
                <CardDescription>
                    Ab dem heutigen Tag bis Ende des Monats werden die Kosten basierend auf dem bisherigen Verbrauch
                    hochgerechnet
                </CardDescription>
            </CardHeader>
            <CardContent>
                <CostChart energyDataRaw={energyDataRaw} userData={userData} />
            </CardContent>
        </Card>
    );
}
