    ...
    return (
        <Card style={{ position: "relative" }}>
            ...
            <div style={{ position: "absolute", top: "10px", right: "10px" }}>
                <InfoDialog description="Die Berechnung erfolgt basierend auf dem Stromverbrauch des aktuellen und letzten Monat in Euro und Prozent, wobei die Kosten für den Basispreis und den Arbeitspreis pro kWh berücksichtigt werden." />
            </div>
            <CardContent>
                {predictedCost ? (
