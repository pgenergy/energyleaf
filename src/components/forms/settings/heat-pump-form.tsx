...
import { updateSimulationHeatPumpSettingsAction } from "@/server/actions/simulations";
...
export default function HeatPumpForm(props: Props) {
	const defaultValues: HeatPumpSettingsInput = {
		source: props.initialValues.source,
		powerKw: props.initialValues.powerKw,
		bufferLiter: props.initialValues.bufferLiter,
		defaultSchedule:
	...
	const form = useForm({
		...
		onSubmit: async ({ value }) => {
			...
			const res = await updateSimulationHeatPumpSettingsAction(value as z.infer<typeof heatPumpSettingsSchema>);
			if (!res.success) {
